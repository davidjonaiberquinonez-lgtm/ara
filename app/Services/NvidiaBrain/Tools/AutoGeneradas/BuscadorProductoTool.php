 ...
 */
final class BuscadorProductoTool implements AgentToolInterface
{
    private const QUERY = 'SELECT * FROM art WHERE co_art = :co_art';
    ...
    {
        return 'busca un producto específico por su código y devuelve todos sus detalles';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'busca un producto específico por su código y devuelve todos sus detalles');
            if ($total > 0) {
