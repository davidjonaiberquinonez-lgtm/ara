 ...
 */
final class FacturaManager2Tool implements AgentToolInterface
{
    ...
    {
        return 'obtener_facturas_pendientes_3_2';
    }

    public function getDescription(): string
    {
        return 'obtiene las facturas pendientes para un cliente específico identificado por su código, filtrando aquellas con saldo mayor a cero.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'obtiene las facturas pendientes para un cliente específico identificado por su código, filtrando aquellas con saldo mayor a cero.');
            if ($total > 0) {
