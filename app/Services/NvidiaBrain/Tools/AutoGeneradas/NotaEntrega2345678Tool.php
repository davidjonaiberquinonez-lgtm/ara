 ...
 */
final class NotaEntrega2345678Tool implements AgentToolInterface
{
    private const QUERY = 'SELECT nota_num, factura_num, num_fact FROM subruta_items WHERE factura_num = :factura_num OR num_fact = :num_fact';

    public function getName(): string
    {
        return 'obtener_nota_entrega_3_2_3_4_5_6_7_8';
    }

    public function getDescription(): string
    {
        return 'Obtiene el número de la nota de entrega asociada a una factura específica.';
    }
    ...
    public function getParameters(): array
    {
        return [
            ...
            'properties' => [
                ...
                'num_fact' => ['type' => 'number', 'description' => 'Valor para el filtro num_fact.'],
            ],
            'required' => ['factura_num', 'num_fact'],
        ];
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO('sqlite:C:\\ARA_PROYECT\\ara\\ARA_Brain\\data\\proyecto_ara.db', null, null, [
            ...
            $stmt->bindValue(':num_fact', (float) ($arguments['num_fact'] ?? 0));
            $stmt->execute();
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene el número de la nota de entrega asociada a una factura específica.');
            if ($total > 0) {
