 ...
 */
final class FacturasPendientesTool implements AgentToolInterface
{
    ...
    {
        return 'facturas_pendientes_cliente';
    }

    public function getDescription(): string
    {
        return 'Obtiene las facturas con saldo pendiente de un cliente específico.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene las facturas con saldo pendiente de un cliente específico.');
            if ($total > 0) {
