 ...
 */
final class RutasActivasTool implements AgentToolInterface
{
    private const QUERY = 'SELECT user_id, ruta_macro, sede, actualizado_en FROM sesiones_ruta_activa WHERE user_id != \'TEST_PERSIST\'';

    public function getName(): string
    {
        return 'obtener_rutas_activas';
    }

    public function getDescription(): string
    {
        return 'Obtiene las rutas activas de los usuarios, excluyendo las de prueba, para monitorear su estado y ubicación.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO('sqlite:C:\\ARA_PROYECT\\ara\\ARA_Brain\\data\\proyecto_ara.db', null, null, [
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene las rutas activas de los usuarios, excluyendo las de prueba, para monitorear su estado y ubicación.');
            if ($total > 0) {
