 ...
 */
final class DetalleNotaTool implements AgentToolInterface
{
    private const QUERY = 'SELECT * FROM detalle_nota';

    public function getName(): string
    {
        return 'obtener_detalles_nota';
    }

    public function getDescription(): string
    {
        return 'Recupera todos los registros de la tabla detalle_nota para revisar los detalles de las notas de entrega.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO('sqlite:C:\\ARA_PROYECT\\ara\\ARA_Brain\\data\\proyecto_ara.db', null, null, [
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Recupera todos los registros de la tabla detalle_nota para revisar los detalles de las notas de entrega.');
            if ($total > 0) {
