 ...
 */
final class FacturaTool implements AgentToolInterface
{
    private const QUERY = 'SELECT * FROM factura WHERE fact_num = :fact_num';
    ...
    {
        return 'Obtiene una factura específica de la base de datos utilizando su número para recuperar sus detalles.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene una factura específica de la base de datos utilizando su número para recuperar sus detalles.');
            if ($total > 0) {
