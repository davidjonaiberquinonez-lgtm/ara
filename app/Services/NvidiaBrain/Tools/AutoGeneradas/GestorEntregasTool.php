 ...
 */
final class GestorEntregasTool implements AgentToolInterface
{
    private const QUERY = 'SELECT TOP 3 co_art, art_des FROM art WHERE co_art IN (\'MD01600\', \'MD04671\', \'MD01961\')';

    public function getName(): string
    {
        return 'obtener_articulos_nota';
    }

    public function getDescription(): string
    {
        return 'Consulta los códigos y descripciones de los artículos asociados a una nota de entrega para obtener información básica de los productos cuando se requiere revisar los detalles de una entrega específica.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Consulta los códigos y descripciones de los artículos asociados a una nota de entrega para obtener información básica de los productos cuando se requiere revisar los detalles de una entrega específica.');
            if ($total > 0) {
