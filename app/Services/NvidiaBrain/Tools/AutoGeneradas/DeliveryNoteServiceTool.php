 ...
 */
final class DeliveryNoteServiceTool implements AgentToolInterface
{
    private const QUERY = 'SELECT num_doc FROM reng_fac WHERE fact_num = :fact_num AND tipo_doc = :tipo_doc';
    ...
    {
        return 'Obtiene el número de la nota de entrega asociada a una factura específica, útil para rastrear documentos de envío en procesos logísticos o de facturación.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene el número de la nota de entrega asociada a una factura específica, útil para rastrear documentos de envío en procesos logísticos o de facturación.');
            if ($total > 0) {
