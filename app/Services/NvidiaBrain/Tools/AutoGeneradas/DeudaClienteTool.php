 ...
 */
final class DeudaClienteTool implements AgentToolInterface
{
    ...
    {
        return 'Obtiene las facturas pendientes de pago de un cliente específico.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene las facturas pendientes de pago de un cliente específico.');
            if ($total > 0) {
