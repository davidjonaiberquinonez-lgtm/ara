 ...
 */
final class NotaEntrega234567Tool implements AgentToolInterface
{
    private const QUERY = 'SELECT * FROM reng_fac WHERE num_doc = :num_doc';

    public function getName(): string
    {
        return 'obtener_nota_entrega_2_3_4_5_6_7';
    }

    public function getDescription(): string
    {
        return 'obtiene los detalles de una nota de entrega específica en la base de datos SQLite utilizando el número de documento.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'obtiene los detalles de una nota de entrega específica en la base de datos SQLite utilizando el número de documento.');
            if ($total > 0) {
