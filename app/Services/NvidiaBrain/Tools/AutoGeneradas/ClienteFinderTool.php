 ...
 */
final class ClienteFinderTool implements AgentToolInterface
{
    private const QUERY = 'SELECT co_cli, cli_des, rif FROM clientes WHERE co_cli = :co_cli';
    ...
    {
        return 'Obtiene los datos de un cliente específico por su código, útil para consultas de facturación o verificación de información.';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Obtiene los datos de un cliente específico por su código, útil para consultas de facturación o verificación de información.');
            if ($total > 0) {
