 ...
 */
final class NotaFinderTool implements AgentToolInterface
{
    ...
    {
        return 'Busca una nota específica en la base de datos de renglones de facturas según su número de documento';
    }
    ...
    public function execute(array $arguments, array $contexto): array
    {
        ...
        $pdo = new PDO(
            ...
            $filas = $stmt->fetchAll();
            $total = count($filas);
            $cb = CardBuilder::iniciar('🤖', 'Busca una nota específica en la base de datos de renglones de facturas según su número de documento');
            if ($total > 0) {
